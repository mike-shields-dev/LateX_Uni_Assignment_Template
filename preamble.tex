...
% Define a new command for page break before section titles
\newcommand{\sectionbreak}{\clearpage}

% Redefine section commands to include a page break
...
\titleformat{\section}
  ...
  {1em}
  {} % Empty space for title text formatting
...
\fancyhead[L]{Student ID: \studentid} % Left of header with section name
